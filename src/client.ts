...
import { Forecast, ForecastRetrieveParams, ForecastRetrieveResponse } from './resources/forecast';
...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['OPEN_METEO_LOG'] or 'warn' if it isn't set.
   */
...
export class OpenMeteo {
  ...
  constructor({ baseURL = readEnv('OPEN_METEO_BASE_URL'), ...opts }: ClientOptions = {}) {
    ...
    this.timeout = options.timeout ?? OpenMeteo.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('OPEN_METEO_LOG'), "process.env['OPEN_METEO_LOG']", this) ??
      defaultLogLevel;
  ...
  static OpenMeteo = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static OpenMeteoError = Errors.OpenMeteoError;
  ...
  forecast: API.Forecast = new API.Forecast(this);
}

OpenMeteo.Forecast = Forecast;

export declare namespace OpenMeteo {
